...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        ...
        <link rel="shortcut icon" href="https://cdn.discordapp.com/attachments/997187785154908311/1016646317981839380/iqologo.png" type="image/x-icon" width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">iqo</p>
      ...
      <div className="bg-neutral-800/5">
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            <div>
              <p>❤️ Created by iqo</p></div>
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://discord.gg/J69KSqvGeq" target="_blank" rel="noreferrer" className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
